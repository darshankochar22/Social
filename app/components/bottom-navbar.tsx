...
export default function BottomNavBar() {
  ...
  const navItems = [
    ...
    { id: 'communities', icon: Users, label: 'Communities', path: '/discover' },
    { id: 'reels', icon: Play, label: 'Reels', path: '/reel' },
    { id: 'notifications', icon: Bell, label: 'Notifications', badge: notificationCount, path: '/home' },
    { id: 'profile', icon: User, label: 'Profile', path: '/profile' }
  ];

  const onClickItem = (item: typeof navItems[number]) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      {/* Main Content Area placeholder removed in layout usage */}
